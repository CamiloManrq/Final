...
<body>
    ...
    <div class='container'>
        ...
        <form method="POST" enctype="multipart/form-data">
            <div class="row mb-2">
                <div class="cold">
                    <input type="text" name="nombres" id="nombres" placeholder="nombres" class="form-control" value="<?= $dp->nombres?>"/>
                </div>
                <input type="hidden" name="id" value="<?=$dp->id ?>" />


                <div class= "col">
                    <input type="text" name="apellidos" id="apellidos" placeholder="Apellido" class="form-control" value="<?= $dp->apellidos?>"/>
                </div>
            </div>

            <div class="row mb-2">
                <div class="cold">
                    <input type="text" name="email" id="email" placeholder="Email" class="form-control" value="<?= $dp->email?>"/>
                </div>
                <div class= "col">
            ...
            <div class="row mb-2">
                <div class="cold">
                    <textarea name="comentarios" id="comentarios" placeholder="Comentarios"  class="form-control" ><?= $dp->comentarios?></textarea>
                </div>
                <div class= "col">
                    <input type="text" name="nombredelaempresa" id="nombredelaempresa" placeholder="Nombre de la empresa" class="form-control"value="<?= $dp->nombredelaempresa?>"/>
                </div>
            </div>
